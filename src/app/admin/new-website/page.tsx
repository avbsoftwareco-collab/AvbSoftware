...
//           <div className="bg-white rounded-2xl p-8 border border-[#E8DEC8] shadow-md">
//             <h2 className="text-3xl font-bold text-[#2B2419] mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
//               Step 2: Business <span className="italic gradient-text">Info</span>
//             </h2>
...
//                   <input type="tel" value={formData.phone} onChange={(e) => handleChange("phone", e.target.value)} placeholder="+91 9876543210" className="w-full px-4 py-3 bg-[#FAF5EA] border border-[#E8DEC8] rounded-xl outline-none focus:border-[#8B6F47]" />
//                 </div>
//                 <div>
//                   <label className="block text-sm font-bold text-[#2B2419] mb-2">WhatsApp</label>
//                   <input type="tel" value={formData.whatsapp} onChange={(e) => handleChange("whatsapp", e.target.value)} placeholder="919876543210" className="w-full px-4 py-3 bg-[#FAF5EA] border border-[#E8DEC8] rounded-xl outline-none focus:border-[#8B6F47]" />
//                 </div>
//                 <div>
...
//               <button onClick={() => setStep(3)} className="flex-1 py-3 bg-gradient-to-r from-[#8B6F47] to-[#6B5535] text-white font-bold rounded-xl flex items-center justify-center gap-2">
...
//                   URL: <code className="bg-white px-2 py-0.5 rounded">{formData.subdomain}.avbsoftware.com</code>
//                 </p>
//               </div>
//             </div>

//             <div className="flex gap-3">
//               <button onClick={() => setStep(3)} className="flex-1 py-3 bg-[#FAF5EA] text-[#8B6F47] font-bold rounded-xl">← Edit</button>
